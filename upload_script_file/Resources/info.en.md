...
This vulnerability shows that you should not trust only the `Content-Type` header. You should also check the real file itself, on the client side or on the server side, depending on the web app design:
